...
id = 'id'
badge = 'badge'
tk = '__mytrans__miammmm__authorisation__token__'
rTk = '__transport__milouuuu__authorisation__refresh__token__'
collUser = 'utilisateur'
collDmd = 'demande'
collConf = 'confirmer'
collVld = 'valider'
role = 'role'
...
# }
    crtUser:{
        ...
        field: [prenom,nom,badge,email,numero,ste,dept,role,niveau],
        lbl: 'Envoyer / Send',
        lk: links[lkCrtUsr]
    },
    urg:{
...
bus_depart = [0,2,4]
vol = [2,4]
dmdFields = [id,lieu,date,badge,statut,dateDepart,sc,raison,dateConf,dept,niveau,ste,nbrEnf,dateArrivee,nomC,numero,moyen,heberger,trainee,email]
vDt = [{
